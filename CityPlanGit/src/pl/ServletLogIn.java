...
public class ServletLogIn extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (tipoUsuario.equals("cliente")) {
			...
			// >>¿COMO HAGO? creo un b¡objeto y busco el nombre en la BBDD y despues comparo
			// con el password??
			// comparar datos del cliente
			if (usuario != cliente.getNombreCliente() || password != cliente.getPasswordCliente()) {
			...
			if (usuario != comerciante.getNombreComerciante() || password != comerciante.getPasswordComerciante()) {
				vistaPag.verErrorLogIn(pw, " ");// Falta poner el mensaje de error de acceso
			} else {
